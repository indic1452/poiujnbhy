...
COLUMN_MIGRATIONS: tuple[tuple[str, str, str], ...] = (
    ...
    # Отдел и группа военнослужащего: без них сводка не может показать ни
...
#: штатными должностями компании. Без переноса военнослужащий с ролью, которой
...
class Database:
    ...
    def _rename_roles(self) -> None:
        """Перевод военнослужащих на штатные должности.
        ...
        военнослужащих, придётся на изолированной машине без разработчика.
        """
