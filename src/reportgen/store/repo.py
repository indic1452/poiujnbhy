...
class UserRepo:
    ...
    def delete(self, user_id: int) -> None:
        ...
        Отклонённая заявка — это не военнослужащий: держать её в списке отдела
    ...
    def list_all(self, active_only: bool = False, staff_only: bool = False) -> List[User]:
        ...
        В разделе «Военнослужащие» он, наоборот, обязан быть виден — это
        ...
        # Неодобренная заявка — ещё не военнослужащий: в списках отдела, в выборе
...
class PersonFileRepo:
    """Личные документы военнослужащего: справка-объективка и всё, что к ней."""
...
class BoardRepo:
    ...
    def workload(self, today: str) -> List[Dict[str, Any]]:
        ...
        rows = self.db.query(
            ...
            # Заявка на доступ — ещё не военнослужащий: в сводке отдела ей делать
