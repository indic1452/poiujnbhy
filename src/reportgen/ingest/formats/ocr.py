...
Русская техническая литература в библиотеке отдела — это чаще всего скан.
...
def tesseract_binary() -> str | None:
    ...
    в контуре отдела PATH после установки правят далеко не всегда.
    """
...
def ocr_image(
    ...
    *,
    ...
    # отдела по-русски названо почти всё: работаем по временной копии с
...
def image_frame_count(path: Path) -> int:
    ...
    библиотеке отдела такие файлы обычные. Раньше весь такой файл уходил в
