...
Библиотека отдела копилась десятилетиями, и половина методичек и
...
#: что без этого списка на машине отдела ничего не найдётся.
...
def convert_with_soffice(
    ...
    *,
    ...
    Исходный файл копируется во временный каталог. Так библиотека отдела
