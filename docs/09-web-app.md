...
инженер ведёт входящее письмо заказчика — от регистрации до подписанного
...
**О названиях.** В интерфейсе обращение заказчика называется письмом: пришло
...
луч на наземную станцию. Кадр лежит в поставке файлом
`static/login-bg.jpg` и собирается сценарием `tools/make_login_bg.py`, так
что изолированная машина ничего не скачивает. Свой снимок ставится без правки
