...
Одно письмо заводится один раз: повторный входящий номер отвергается с
указанием, под каким учётным номером оно уже зарегистрировано. Единственность
учётного номера от этого не спасает — его придумывает система, а входящий стоит
на бумаге, и письмо, заведённое дважды, законно получало два отчёта и два
разных исходящих номера.
