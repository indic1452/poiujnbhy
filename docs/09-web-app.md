...
![Рабочее место инженера: факт-пакет, отчёт по секциям, источники](images/ui-case.png)
...
модель, и замечания верификатора. Название компании, подзаголовок и акцентный
цвет берутся из настроек (`brand_name`, `brand_subtitle`, `brand_accent`,
`brand_logo`), так что интерфейс выглядит как ваш, а не как чужой.

![Список обращений](images/ui-cases.png)
