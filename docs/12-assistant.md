...
разговор, сам вопрос, карточка письма, карта библиотеки с оглавлениями и
фрагменты. Собранный материал сверяется с границей ещё раз — уже по готовому
тексту: сначала система отказывается от оглавлений документов (самое
необязательное — они лишь подсказывают, что ещё есть в документе), и только
потом от хвоста подборки.
